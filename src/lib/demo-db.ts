...
const glamourExtraStaff: Staff[] = [
  { id: ST.nadia, salon_id: GL_SALON, branch_id: GL_BRANCH, name: 'Nadia Hussain', phone: '0333-4567890', role: 'senior_stylist', photo_url: null, pin_code: '3456', base_salary: 18000, commission_type: 'percentage', commission_rate: 30, join_date: '2024-08-01', is_active: true, created_at: '2024-08-01T00:00:00Z' },
  { id: ST.rabia, salon_id: GL_SALON, branch_id: GL_BRANCH, name: 'Rabia Ali', phone: '0345-6789012', role: 'junior_stylist', photo_url: null, pin_code: '4567', base_salary: 12000, commission_type: 'percentage', commission_rate: 20, join_date: '2024-09-01', is_active: true, created_at: '2024-09-01T00:00:00Z' },
];
...
const glamourProducts: Product[] = [
  { id: PR_GL[0], salon_id: GL_SALON, name: 'Casting Creme Gloss', brand: "L'Oréal", category: 'Hair Color', unit: 'box', content_per_unit: 60, content_unit: 'ml', inventory_type: 'backbar', purchase_price: 450, retail_price: 0, current_stock: 25, low_stock_threshold: 5, is_active: true, created_at: '2025-01-01T00:00:00Z' },
  { id: PR_GL[1], salon_id: GL_SALON, name: 'Semi Color', brand: 'Keune', category: 'Hair Color', unit: 'tube', content_per_unit: 60, content_unit: 'ml', inventory_type: 'backbar', purchase_price: 800, retail_price: 0, current_stock: 15, low_stock_threshold: 3, is_active: true, created_at: '2025-01-01T00:00:00Z' },
  { id: PR_GL[2], salon_id: GL_SALON, name: 'Koleston Perfect', brand: 'Wella', category: 'Hair Color', unit: 'tube', content_per_unit: 60, content_unit: 'ml', inventory_type: 'backbar', purchase_price: 650, retail_price: 0, current_stock: 18, low_stock_threshold: 5, is_active: true, created_at: '2025-01-01T00:00:00Z' },
  { id: PR_GL[3], salon_id: GL_SALON, name: 'Igora Royal', brand: 'Schwarzkopf', category: 'Hair Color', unit: 'tube', content_per_unit: 60, content_unit: 'ml', inventory_type: 'backbar', purchase_price: 750, retail_price: 0, current_stock: 2, low_stock_threshold: 3, is_active: true, created_at: '2025-01-01T00:00:00Z' },
  { id: PR_GL[4], salon_id: GL_SALON, name: 'Nail Lacquer', brand: 'OPI', category: 'Nail Polish', unit: 'bottle', content_per_unit: 15, content_unit: 'ml', inventory_type: 'retail', purchase_price: 350, retail_price: 800, current_stock: 30, low_stock_threshold: 10, is_active: true, created_at: '2025-01-01T00:00:00Z' },
  { id: PR_GL[5], salon_id: GL_SALON, name: 'Keratin Shampoo', brand: 'Keune', category: 'Shampoo', unit: 'bottle', content_per_unit: 500, content_unit: 'ml', inventory_type: 'retail', purchase_price: 900, retail_price: 1800, current_stock: 12, low_stock_threshold: 3, is_active: true, created_at: '2025-01-15T00:00:00Z' },
  { id: PR_GL[6], salon_id: GL_SALON, name: 'Hair Serum', brand: "L'Oréal", category: 'Styling', unit: 'bottle', content_per_unit: 100, content_unit: 'ml', inventory_type: 'retail', purchase_price: 600, retail_price: 1200, current_stock: 8, low_stock_threshold: 3, is_active: true, created_at: '2025-01-15T00:00:00Z' },
  { id: PR_GL[7], salon_id: GL_SALON, name: 'Deep Conditioning Mask', brand: 'Schwarzkopf', category: 'Treatment', unit: 'jar', content_per_unit: 500, content_unit: 'g', inventory_type: 'backbar', purchase_price: 1200, retail_price: 0, current_stock: 6, low_stock_threshold: 2, is_active: true, created_at: '2025-01-15T00:00:00Z' },
  { id: PR_GL[8], salon_id: GL_SALON, name: 'Wax Strips', brand: 'Veet', category: 'Waxing', unit: 'pack', content_per_unit: 20, content_unit: 'strips', inventory_type: 'backbar', purchase_price: 350, retail_price: 0, current_stock: 20, low_stock_threshold: 5, is_active: true, created_at: '2025-02-01T00:00:00Z' },
  { id: PR_GL[9], salon_id: GL_SALON, name: 'Hair Spray', brand: 'TRESemmé', category: 'Styling', unit: 'can', content_per_unit: 250, content_unit: 'ml', inventory_type: 'retail', purchase_price: 500, retail_price: 950, current_stock: 10, low_stock_threshold: 3, is_active: true, created_at: '2025-02-01T00:00:00Z' },
];
...
const royalProducts: Product[] = [
  { id: PR_RB[0], salon_id: RB_SALON, name: 'Hair Wax', brand: 'Gatsby', category: 'Styling', unit: 'jar', content_per_unit: 75, content_unit: 'g', inventory_type: 'retail', purchase_price: 300, retail_price: 600, current_stock: 15, low_stock_threshold: 5, is_active: true, created_at: '2025-02-10T00:00:00Z' },
  { id: PR_RB[1], salon_id: RB_SALON, name: 'Hair Gel', brand: 'Schwarzkopf', category: 'Styling', unit: 'tube', content_per_unit: 150, content_unit: 'ml', inventory_type: 'retail', purchase_price: 400, retail_price: 750, current_stock: 12, low_stock_threshold: 4, is_active: true, created_at: '2025-02-10T00:00:00Z' },
  { id: PR_RB[2], salon_id: RB_SALON, name: 'Just For Men Color', brand: 'Just For Men', category: 'Hair Color', unit: 'box', content_per_unit: 40, content_unit: 'ml', inventory_type: 'backbar', purchase_price: 550, retail_price: 0, current_stock: 10, low_stock_threshold: 3, is_active: true, created_at: '2025-02-10T00:00:00Z' },
  { id: PR_RB[3], salon_id: RB_SALON, name: 'Shaving Cream', brand: 'Nivea', category: 'Shaving', unit: 'can', content_per_unit: 200, content_unit: 'ml', inventory_type: 'backbar', purchase_price: 280, retail_price: 0, current_stock: 8, low_stock_threshold: 3, is_active: true, created_at: '2025-02-10T00:00:00Z' },
  { id: PR_RB[4], salon_id: RB_SALON, name: 'After Shave', brand: 'Old Spice', category: 'Shaving', unit: 'bottle', content_per_unit: 100, content_unit: 'ml', inventory_type: 'retail', purchase_price: 350, retail_price: 700, current_stock: 6, low_stock_threshold: 2, is_active: true, created_at: '2025-02-10T00:00:00Z' },
  { id: PR_RB[5], salon_id: RB_SALON, name: 'Hair Oil', brand: 'Dabur Amla', category: 'Hair Care', unit: 'bottle', content_per_unit: 200, content_unit: 'ml', inventory_type: 'retail', purchase_price: 200, retail_price: 400, current_stock: 20, low_stock_threshold: 5, is_active: true, created_at: '2025-02-10T00:00:00Z' },
  { id: PR_RB[6], salon_id: RB_SALON, name: 'Beard Oil', brand: 'Beardo', category: 'Beard Care', unit: 'bottle', content_per_unit: 30, content_unit: 'ml', inventory_type: 'retail', purchase_price: 450, retail_price: 900, current_stock: 1, low_stock_threshold: 3, is_active: true, created_at: '2025-02-15T00:00:00Z' },
  { id: PR_RB[7], salon_id: RB_SALON, name: 'Hair Spray', brand: 'TRESemmé', category: 'Styling', unit: 'can', content_per_unit: 250, content_unit: 'ml', inventory_type: 'backbar', purchase_price: 500, retail_price: 0, current_stock: 5, low_stock_threshold: 2, is_active: true, created_at: '2025-02-15T00:00:00Z' },
];
...
const allLoyaltyRules: LoyaltyRules[] = [
  { id: 'lr-0001', salon_id: GL_SALON, points_per_100_pkr: 10, pkr_per_point_redemption: 0.5, birthday_bonus_multiplier: 2 },
  { id: 'lr-0002', salon_id: RB_SALON, points_per_100_pkr: 5, pkr_per_point_redemption: 1, birthday_bonus_multiplier: 3 },
];
