              ...
              {appointments.map((apt) => {
                ...
                return (
                  <Link
                    ...
                    className="flex items-center gap-3 bg-background/50 border border-border p-3 rounded-lg hover:border-border/60 transition-all duration-200 animate-fade-up"
                  >
