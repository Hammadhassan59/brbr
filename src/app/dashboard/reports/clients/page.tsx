    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="new">
        <TabsList className="h-auto gap-1 flex-wrap">
          <TabsTrigger value="new" className="text-xs px-3.5 py-2 gap-1 font-medium transition-all duration-150 data-[state=active]:bg-[#1A1A1A] data-[state=active]:text-white data-[state=active]:border-[#1A1A1A] border border-border text-muted-foreground hover:text-foreground hover:border-foreground/30"><UserPlus className="w-3 h-3" /> New ({newClients.length})</TabsTrigger>
          <TabsTrigger value="udhaar" className="text-xs px-3.5 py-2 gap-1 font-medium transition-all duration-150 data-[state=active]:bg-[#1A1A1A] data-[state=active]:text-white data-[state=active]:border-[#1A1A1A] border border-border text-muted-foreground hover:text-foreground hover:border-foreground/30"><CreditCard className="w-3 h-3" /> Udhaar ({udhaarClients.length})</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="new" className="mt-4">
          <Card className="border-border">
            ...
            <CardContent className="px-0">
              {loading ? <div className="h-20 bg-muted rounded-lg animate-pulse mx-4" /> : newClients.length === 0 ? (
        ...
        <TabsContent value="udhaar" className="mt-4 space-y-4">
          <Card className="border-border border-red-500/20 bg-red-500/10">
