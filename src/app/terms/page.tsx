      ...
      <div className="max-w-3xl mx-auto px-5 py-16 md:py-24">
        ...
        <div className="space-y-8 text-sm text-[#1A1A1A]/70 leading-relaxed">
          ...
          <section>
            ...
            <p>
              BrBr is a cloud-based salon management system (SaaS) provided by Inparlor Technologies Pvt Ltd. By creating an account, you agree to these terms. If you do not agree, do not use BrBr.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              New accounts get a <strong>14-day free trial</strong>. No credit card is required. At the end of the trial, your account will automatically expire and you will need to subscribe to continue using BrBr. Your data is retained for 90 days after expiry.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              BrBr is billed monthly in Pakistani Rupees (PKR). Prices are shown on our pricing page. We may update prices with 30 days&apos; notice. Your subscription renews automatically each month until you cancel.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We aim to keep BrBr available at all times but do not guarantee any specific uptime (no SLA). We may perform maintenance that causes temporary downtime. We will try to give advance notice for planned outages.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You own your salon data — your clients, transactions, staff records, and business information. We do not claim any ownership over it. We own the BrBr software, its design, and codebase. For details on how we handle your data, see our{' '}
          ...
          <section>
            ...
            <p>
              We may suspend or terminate your account if you use BrBr for illegal activity, abuse our systems or support team, or have an outstanding unpaid balance for more than 14 days after your billing date.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              BrBr is provided &ldquo;as-is.&rdquo; We are not liable for indirect, incidental, or consequential damages, including lost business or data loss. Our total liability to you is capped at the amount you paid us in the 3 months before the incident.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              We may update these terms from time to time. When we do, we will notify you by email and/or an in-app notice. Continued use of BrBr after the effective date means you accept the updated terms.
            </p>
          </section>
